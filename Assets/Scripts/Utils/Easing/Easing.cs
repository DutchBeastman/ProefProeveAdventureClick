...
{
	/// <summary>
	/// See http://easings.net/ for visualizations of each function.
	/// </summary>
	public static class Easing
	{
		public static float Ease(EasingType type , float start , float end , float value)
		{
			switch (type)
			{
				...
				default:
					throw new System.ArgumentException("[Easing] Unknown EasingType! " + type);
			}
		}
